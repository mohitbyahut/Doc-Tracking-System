              ...
              <div className="role-buttons">
                <Link to="/doctor-landing" className="role-btn doctor">
                  ...
                  <div className="role-content">
                    <h4>For Doctors</h4>
                    <p>
                      Manage your schedule, update status, and track patients
                    </p>
                  </div>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                    <path
        ...
        <div className="container">
          ...
          <div className="footer-bottom">
            ...
            <div className="footer-social">
              <a href="#">Twitter</a>
              <a href="www.linkedin.com/in/raman-kumar0" target="blank">
                LinkedIn
              </a>
              <a href="https://github.com/ramansingh19 " target="blank">
                GitHub
              </a>
            </div>
          </div>
