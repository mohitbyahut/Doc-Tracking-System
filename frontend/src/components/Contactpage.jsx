...
export default function ContactPage() {
  ...
  return (
    <main id="ContactPage" className="dt-contact-root">
      <section
        id="ContactPage"
        className="dt-contact-card"
        aria-labelledby="contact-heading"
      >
        <div className="dt-contact-left">
          <h1 id="contact-heading">Contact DoctorTracker</h1>
          <p className="lead">
            Questions about integration, pricing, or help with tracking — drop
            us a message.
          </p>
          ...
          <ul className="contact-info" aria-label="Office contact information">
            ...
            <li>
              <strong>Email:</strong>
              <a href="mailto:support@doctracker.example">
          ...
          <div className="socials" aria-hidden>
            ...
            <a className="btn-ghost" href="www.linkedin.com/in/raman-kumar0">
              LinkedIn
            </a>
            <a className="btn-ghost" href="https://github.com/ramansingh19">
              GitHub
            </a>
          </div>
        </div>
        ...
        <form className="dt-contact-form" onSubmit={handleSubmit} noValidate>
          ...
          <label className="field">
            ...
            <input
              ...
              value={form.subject}
              onChange={updateField}
              placeholder="e.g. Integration question"
            />
          </label>
          ...
          {status && (
            <div
              className={`status ${status.type === "error" ? "err" : "ok"}`}
              role="status"
            >
              {status.text}
            </div>
          ...
          <div className="actions">
            ...
            <button
              ...
              onClick={() => {
                // mailto fallback
                window.location.href = `mailto:support@doctracker.example?subject=${encodeURIComponent(
                  form.subject || "Contact from DoctorTracker site"
      ...
      <footer className="dt-contact-footer">
        <small>
          © {new Date().getFullYear()} DoctorTracker — Built for hospitals &
          clinics
        </small>
      </footer>
    </main>
