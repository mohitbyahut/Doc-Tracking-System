        ...
        <div className="hero-container">
          <div className="hero-content">
            ...
            <p className="hero-description">
              Track your doctor's real-time location, get accurate wait times,
              and receive instant notifications. Make your hospital visits
              stress-free with our intelligent patient management system.
            </p>
        ...
        <div className="container">
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p>
                See your exact position in the queue and get accurate wait time
                estimates. No more guessing games.
              </p>
            ...
            <div className="feature-card">
              ...
              <p>
                Know exactly where your doctor is and when they'll arrive. Get
                precise ETA updates.
              </p>
              <div className="feature-highlight">
            ...
            <div className="feature-card">
              ...
              <p>
                Get instant alerts when your turn is approaching, doctor
                arrives, or queue status changes.
              </p>
              <div className="feature-highlight">
            ...
            <div className="feature-card">
              ...
              <p>
                Check in remotely and join the queue from anywhere. No need to
            ...
            <div className="feature-card">
              <div className="feature-icon">
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
                  <path
                    d="M8 7V3C8 2.44772 8.44772 2 9 2H15C15.5523 2 16 2.44772 16 3V7M8 7H6C4.89543 7 4 7.89543 4 9V19C4 20.1046 4.89543 21 6 21H18C19.1046 21 20 20.1046 20 19V9C20 7.89543 19.1046 7 18 7H16M8 7H16"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <p>
                View your past appointments, doctor notes, and medical history
            ...
            <div className="feature-card">
              ...
              <p>
                Urgent cases get priority treatment. The system automatically
                adjusts queue for emergencies.
              </p>
              <div className="feature-highlight">
      ...
      <section className="benefits">
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              Join thousands of patients who have transformed their hospital
              experience
            </p>
          </div>
          <div className="benefits-grid">
            <div className="benefit-card">
              ...
              <p>
                Patients spend significantly less time waiting with our
            ...
            <div className="benefit-card">
              ...
              <p>
                Overwhelming majority of patients report improved experience and
                reduced anxiety.
              </p>
            </div>
            <div className="benefit-card">
              ...
              <p>
                Check your status anytime, anywhere. No more uncertainty about
                your appointment.
              </p>
            </div>
          </div>
      ...
      <section className="cta-section">
        <div className="container">
          <div className="cta-content">
            ...
            <p>
              Join thousands of patients who have made their hospital visits
