      ...
      <div className="container">
        ...
        <div className="features-showcase">
          ...
          <div className="feature-content">
            <div
              className={`feature-display ${isAnimating ? "animating" : ""}`}
            >
              <div className="feature-main">
                <div className="feature-header">
                  <div className="feature-icon">
                    {industryFeatures[activeFeature].icon}
                  </div>
                ...
                <div className="feature-details">
                  <div className="feature-list">
                    ...
                    <ul>
                      {industryFeatures[activeFeature].features.map(
                        (item, index) => (
                          <li key={index}>
        ...
        <div className="enterprise-benefits">
          ...
          <div className="benefits-grid">
            <div className="benefit-card">
              ...
              <p>
                Enterprise security standards with SOC 2 Type II certification
            ...
            <div className="benefit-card">
              ...
              <h4>Proven ROI</h4>
              <p>
                Average 40% reduction in wait times and 25% increase in patient
                satisfaction scores.
              </p>
            </div>
            <div className="benefit-card">
              ...
              <p>
                Seamless integration with existing EHR systems and hospital
                infrastructure.
              </p>
            </div>
            <div className="benefit-card">
              ...
              <h4>Global Scale</h4>
              <p>
                Deployed in 50+ countries with multi-language support and local
                compliance.
              </p>
            </div>
          </div>
        ...
        <div className="cta-section">
          <div className="cta-content">
            ...
            <p>
              Join 500+ hospitals worldwide using DocTracker to improve patient
            ...
            <div className="cta-buttons">
              ...
              <button className="cta-button secondary">
                <a href="components/Project.pdf" download>
