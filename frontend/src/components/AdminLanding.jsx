        ...
        <div className="hero-container">
          <div className="hero-content">
            ...
            <p className="hero-description">
              Monitor system performance, manage doctor schedules, analyze
              patient flow, and optimize hospital operations with our
              comprehensive administrative dashboard. Make data-driven decisions
        ...
        <div className="container">
          ...
          <div className="features-grid">
            <div className="feature-card">
              <div className="feature-icon">
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
                  ...
                  />
                  <path
                    d="M3 5C3 3.89543 3.89543 3 5 3H19C20.1046 3 21 3.89543 21 5V18C21 19.1046 20.1046 20 19 20H5C3.89543 20 3 19.1046 3 18V5Z"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <p>
                Monitor system performance, patient flow, doctor efficiency, and
            ...
            <div className="feature-card">
              ...
              <p>
                Add, remove, and manage doctors, staff, and patients. Control
            ...
            <div className="feature-card">
              ...
              <p>
                Configure hospital settings, notification preferences, queue
            ...
            <div className="feature-card">
              <div className="feature-icon">
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
                  <path
                    d="M9 17V7M15 17V7M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <p>
                Generate comprehensive reports on patient satisfaction, doctor
            ...
            <div className="feature-card">
              ...
              <p>
                Handle emergency situations, priority cases, and critical alerts
                with specialized admin controls.
              </p>
              <div className="feature-highlight">
            ...
            <div className="feature-card">
              ...
              <p>
                Configure all system parameters, security settings, backup
        ...
        <div className="container">
          ...
          <div className="analytics-grid">
            <div className="analytics-card">
              ...
              <p>
                Track patient movement, peak hours, and bottleneck
                identification for optimal resource allocation.
              </p>
            </div>
            <div className="analytics-card">
              ...
              <p>
                Monitor doctor efficiency, patient satisfaction scores, and
            ...
            <div className="analytics-card">
              ...
              <p>
                Analyze wait patterns and implement strategies to reduce patient
                waiting times.
              </p>
            </div>
            <div className="analytics-card">
              ...
              <h3>Cost Analysis</h3>
              <p>
                Track operational costs, resource utilization, and ROI of
      ...
      <section className="cta-section">
        <div className="container">
          <div className="cta-content">
            ...
            <p>
              Join leading hospitals that have transformed their operations with
        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-brand">
              ...
              <p>
                Empowering healthcare administrators with intelligent management
                tools.
              </p>
            </div>
