    ...
    <div className="line-chart">
      <div className="chart-container">
        <svg viewBox="0 0 400 200" className="chart-svg">
          ...
          <path
            d={`M 40 ${
              160 - (data.datasets[0].data[0] / 100) * 120
            } ${data.datasets[0].data
              .map(
                (value, i) => `L ${60 + i * 50} ${160 - (value / 100) * 120}`
              )
          ...
          {data.datasets[0].data.map((value, i) => {
            ...
            return (
              <path
                ...
                } A 80 80 0 ${percentage > 0.5 ? 1 : 0} 1 ${
                  100 + 80 * Math.cos(((endAngle - 90) * Math.PI) / 180)
                } ${100 + 80 * Math.sin(((endAngle - 90) * Math.PI) / 180)} Z`}
                fill={data.datasets[0].backgroundColor[i]}
                stroke="white"
                strokeWidth="2"
              />
  ...
  const getChartConfig = () => {
    switch (type) {
      case "patientFlow":
        return {
          chartType: "line",
          data: data.patientFlow,
          title: "Patient Flow",
          subtitle: "Patients per hour",
        };
      case "doctorEfficiency":
        return {
          chartType: "bar",
          data: data.doctorEfficiency,
        ...
        {chartConfig.data.datasets[0].data && (
          <div className="stat-item">
            ...
            <span className="stat-value">
              {(
                chartConfig.data.datasets[0].data.reduce((a, b) => a + b, 0) /
