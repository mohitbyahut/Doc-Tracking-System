...
const NotificationSystem = ({ userRole = "patient" }) => {
  ...
  useEffect(() => {
    const generateNotifications = () => {
      const roleNotifications = {
        doctor: [
          ...
          },
          {
            ...
            message: "Your next appointment is in 15 minutes",
            time: "5 min ago",
            read: false,
          },
          {
            ...
            message: "Sarah Wilson has arrived for her appointment",
            time: "10 min ago",
            read: true,
          },
        ],
        patient: [
          {
            ...
            type: "info",
            title: "Queue Update",
            message: "You are now position #3 in the queue",
            time: "1 min ago",
            read: false,
          },
          {
            ...
            message: "Dr. Johnson is now available and will see you soon",
            time: "3 min ago",
            read: false,
          },
          {
        ...
        admin: [
          {
            ...
            type: "urgent",
            title: "System Alert",
            message: "High patient volume detected in Emergency Department",
            time: "1 min ago",
            read: false,
          },
          {
            ...
            message: "Daily efficiency report is ready for review",
            time: "5 min ago",
            read: false,
          },
          {
      ...
      setUnreadCount(
        roleNotifications[userRole]?.filter((n) => !n.read).length || 0
      );
    };
