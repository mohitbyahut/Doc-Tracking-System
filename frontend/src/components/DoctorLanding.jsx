        ...
        <div className="hero-container">
          <div className="hero-content">
            ...
            <p className="hero-description">
              Manage your schedule, update patient status, share your location,
              and optimize your workflow with our comprehensive doctor
              management platform. Focus on what matters most - patient care.
            </p>
        ...
        <div className="container">
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p>
                AI-powered scheduling optimization, automatic patient reminders,
                and intelligent time slot allocation.
              </p>
            ...
            <div className="feature-card">
              ...
              <p>
                Update your availability status instantly. Patients get notified
                automatically when you're available.
              </p>
              <div className="feature-highlight">
            ...
            <div className="feature-card">
              ...
              <p>
                Share your location with patients for accurate ETA updates.
                Privacy controls ensure you're always in control.
              </p>
              <div className="feature-highlight">
            ...
            <div className="feature-card">
              ...
              <p>
                View and manage your patient queue in real-time. Prioritize
                urgent cases and optimize consultation flow.
              </p>
              <div className="feature-highlight">
            ...
            <div className="feature-card">
              ...
              <p>
                Track your performance metrics, patient satisfaction scores, and
                optimize your practice efficiency.
              </p>
              <div className="feature-highlight">
            ...
            <div className="feature-card">
              ...
              <p>
                Receive instant notifications for emergency cases and urgent
                patient requests. Never miss critical situations.
              </p>
              <div className="feature-highlight">
      ...
      <section className="cta-section">
        <div className="container">
          <div className="cta-content">
            ...
            <p>
              Join thousands of doctors who have already improved their
        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-brand">
              ...
              <p>
                Empowering doctors with intelligent healthcare management tools.
              </p>
            </div>
